...
export const componentApi = {
  ...
  getComponents: async (
    ...
    const url = `${ENV.api.baseUrl}/v1/components${
  ...
  getComponentById: async (id: string): Promise<ComponentDto> => {
    const response = await axios.get<ComponentDto>(
      `${ENV.api.baseUrl}/v1/components/${id}`
    );
    return response.data;
  },
  ...
  createComponent: async (
    ...
    const response = await axios.post<ComponentDto>(
      `${ENV.api.baseUrl}/v1/components`,
      componentData
    );
    return response.data;
  },
  ...
  updateComponent: async (
    ...
    const response = await axios.put<ComponentDto>(
      `${ENV.api.baseUrl}/v1/components/${id}`,
      componentData
    );
    return response.data;
